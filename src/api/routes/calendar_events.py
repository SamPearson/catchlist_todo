...
@calendar_events_bp.route('/api/calendar-events/<int:event_id>/executions', methods=['GET'])
@jwt_required()
...
@calendar_events_bp.route('/api/event-executions/<int:execution_id>', methods=['PUT'])
@jwt_required()
